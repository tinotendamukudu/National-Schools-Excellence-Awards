...
$gownDesignation = isset($data['gownDesignation']) ? $data['gownDesignation'] : '';

if (empty($schoolType) || empty($governanceCategory) || empty($schoolName) || empty($province) || empty($address) || empty($shoulderwidth) || empty($chestwidth) || empty($cuffmeasurement) || empty($sleevelength) || empty($bodylength) || empty($gownDesignation)) {
...
$message = "
    ...
    <body>
        ...
        <p><strong>Gown Designation:</strong> $gownDesignation</p>
    </body>
    </html>
";
